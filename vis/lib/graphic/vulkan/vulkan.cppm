...
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometryTrianglesDataKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::TransformMatrixKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureBuildGeometryInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometryAabbsDataKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureInstanceKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometryInstancesDataKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometryDataKHR>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::CopyAccelerationStructureToMemoryInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CopyMemoryToAccelerationStructureInfoKHR>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineExecutableStatisticValueKHR>;
...
//=== VK_EXT_custom_border_color ===
template <> struct hash<VULKAN_HPP_NAMESPACE::SamplerCustomBorderColorCreateInfoEXT>;
...
//=== VK_NV_ray_tracing_motion_blur ===
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometryMotionTrianglesDataNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureMotionInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureMotionInstanceNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureMotionInstanceDataNV>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureTrianglesOpacityMicromapEXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureTrianglesDisplacementMicromapNV>;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
...
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometryLinearSweptSpheresDataNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometrySpheresDataNV>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ConvertCooperativeVectorMatrixInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceOrHostAddressKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceOrHostAddressConstKHR>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureOpInputNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureInputInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureCommandsInfoNV>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectExecutionSetCreateInfoEXT>;
