...
template <template <typename...> class> struct meta_class_template_tag {};
 ...
 */
template <template <typename...> class Clazz, typename... Args> struct meta_template_traits<Clazz<Args...>> {
