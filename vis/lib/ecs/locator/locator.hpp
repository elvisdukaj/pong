 ...
 */
template <typename Service> class locator final {
...
public:
	 ...
	 */
	template <typename Type = Service, typename... Args> [[nodiscard]] static Service& value_or(Args&&... args) {
	 ...
	 * @return A reference to a valid service.
	 */
	template <typename Type = Service, typename... Args> static Service& emplace(Args&&... args) {
