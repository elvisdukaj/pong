...
struct dense_map_node final {
    ...
    dense_map_node(std::allocator_arg_t, const Allocator &allocator, const std::size_t pos, Args &&...args)
        : next{pos},
          element{vis::ecs::make_obj_using_allocator<value_type>(allocator, std::forward<Args>(args)...)} {}

    template<typename Allocator>
    dense_map_node(std::allocator_arg_t, const Allocator &allocator, const dense_map_node &other)
        : next{other.next},
          element{vis::ecs::make_obj_using_allocator<value_type>(allocator, other.element)} {}
...
struct uses_allocator<vis::ecs::internal::dense_map_node<Key, Value>, Allocator>
    : std::true_type {};
