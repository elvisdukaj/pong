...
template <typename Type, typename It> class resource_cache_iterator final {
	template <typename, typename> friend class resource_cache_iterator;
...
public:
	...
	template <typename... Lhs, typename... Rhs>
	friend constexpr bool operator==(const resource_cache_iterator<Lhs...>&,
																	 const resource_cache_iterator<Rhs...>&) noexcept;
 ...
 */
template <typename Type, typename Loader, typename Allocator> class resource_cache {
	...
	using container_type =
			dense_map<id_type, typename Loader::result_type, identity, std::equal_to<>, container_allocator>;
...
public:
	 ...
	 */
	template <typename... Args> std::pair<iterator, bool> load(const id_type id, Args&&... args) {
	 ...
	 * @copydetails load
	 */
	template <typename... Args> std::pair<iterator, bool> force_load(const id_type id, Args&&... args) {
