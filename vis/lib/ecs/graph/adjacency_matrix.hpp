...
template <typename It> class edge_iterator {
...
[[nodiscard]] constexpr bool operator==(const edge_iterator<Container>& lhs,
																				const edge_iterator<Container>& rhs) noexcept {
 ...
 */
template <typename Category, typename Allocator> class adjacency_matrix {
...
public:
	...
	adjacency_matrix(adjacency_matrix&& other, const allocator_type& allocator)
			: matrix{std::move(other.matrix), allocator}, vert{other.vert} {}
