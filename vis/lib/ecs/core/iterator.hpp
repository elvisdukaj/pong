 ...
 */
template <typename Type> struct input_iterator_pointer final {
	/*! @brief Value type. */
 ...
 */
template <typename Type> class iota_iterator final {
 ...
 */
template <typename It, typename Sentinel = It> struct iterable_adaptor final {
	/*! @brief Value type. */
