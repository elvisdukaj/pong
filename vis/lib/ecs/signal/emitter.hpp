 ...
 */
template <typename Derived, typename Allocator> class emitter {
...
public:
	 ...
	 */
	template <typename Type> void publish(Type value) {
	 ...
	 */
	template <typename Type> void on(std::function<void(Type&, Derived&)> func) {
	 ...
	 */
	template <typename Type> void erase() {
	 ...
	 */
	template <typename Type> [[nodiscard]] bool contains() const {
